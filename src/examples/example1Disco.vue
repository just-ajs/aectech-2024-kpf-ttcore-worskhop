<template>
  ...
  <div id="sidebar">
    ...
    <Slider :title="divisionsHorzSliderName" :min="1" max="10" :step="1" :val="divisionsHorzValue" @update="updateValue"></Slider>
  </div>
...
let inputs = ref({
  ...
  [divisionsHorzSliderName.value] : divisionsHorzValue.value 
});
